   ...
   <?php include 'inc/navbar.php'; ?>
      ...
      <div class="row">
         ...
         <?php
            ...
            $sql = "SELECT us.FirstName, us.LastName, u.NameUniversity, ss.SubmitDate from user us, university u , studentsubmit ss, scholarshipinfor s WHERE ss.IdUser = us.Id and ss.IdScholarship = s.IdScholarship AND s.IdUniversity = u.IdUniversity ORDER BY u.NameUniversity";
            $q = $conn->query($sql);
            $q->setFetchMode(PDO::FETCH_ASSOC);
         ?> 
         <table class="table table-bordered table-condensed">
