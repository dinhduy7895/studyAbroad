...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($user->login($uname,$umail,$upass))
    {
      ...
      } else $user->redirect('test-upload.php');
    }
    else
    {
					...
					<div class="row center">
						<div class="new-single col-lg-12">
							<div class="new-single-image">
								<a href="#">
									<img src="../admin/files/Img_1481434051.jpg"  class="image-responsive" alt="">
								</a>
							</div>
							<div class="new-single-header">
								...
								<h2 class="main-title">
									<a href="#" class="">test upload</a>
								</h2>
								<div class="time-new-single">
									<span>Published at 2016-12-11</span>
								</div>
								<div class="new-single-content">
									<div class="head-context">
									<p>test uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest upload</p>
									</div>
									<br>
									<br>	
									<div class="context">
									<p>test uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest uploadtest upload</p>
									</div> 	
