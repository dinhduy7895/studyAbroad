...
<?php
  ...
  if(isset($_POST['submit']))
  {
	...
	$_SESSION['login'] = true;
      ...
      } else $user->redirect('-d-d-d-d-.php');
    }
    else
    {
					...
					<div class="row center">
						<div class="new-single col-lg-12">
							<div class="new-single-image">
								<a href="#">
									<img src="../admin/files/Img_1481277502.jpg"  class="image-responsive" alt="">
								</a>
							</div>
							<div class="new-single-header">
								...
								<h2 class="main-title">
									<a href="#" class=""> d d d d </a>
								</h2>
								<div class="time-new-single">
									<span>Published at 2016-12-09</span>
								</div>
