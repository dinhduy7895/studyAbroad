...
<?php
  ...
  if($user->is_loggedin()!="" && $_SESSION['login'] == true )
  {
	...
	$user->redirect('CNTT-Schorlarship-2.php');
  ...
  if(isset($_POST['submit']))
  {
	...
	$_SESSION['login'] = true;
      ...
      } else $user->redirect('CNTT-Schorlarship-2.php');
    }
    else
    {
					...
					<div class="row center">
						<div class="new-single col-lg-12">
							<div class="new-single-image">
								<a href="#">
									<img src="../admin/files/Img_1481219952.jpg"  class="image-responsive" alt="">
								</a>
							</div>
							<div class="new-single-header">
								...
								<h2 class="main-title">
									<a href="#" class="">CNTT Schorlarship 2</a>
								</h2>
