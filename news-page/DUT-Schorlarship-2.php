...
<?php
  ...
  if($user->is_loggedin()!="" && $_SESSION['login'] == true )
  {
	...
	$user->redirect('DUT-Schorlarship-2.php');
  ...
  if(isset($_POST['submit']))
  {
	...
	$_SESSION['login'] = true;
      ...
      } else $user->redirect('DUT-Schorlarship-2.php');
    }
    else
    {
...
?>
<?php  
	$sql = "SELECT u.NameUniversity, m.NameMajor, s.Fee, s.Scholarship, S.StartDay, S.EndDay, s.NumberOfYear FROM university u, major m, scholarshipinfor s where  s.IdScholarship = '4' and s.IdUniversity = u.IdUniversity and s.IdMajor = m.IdMajor";
	$q = $conn->query($sql);
					...
					<div class="row center">
						<div class="new-single col-lg-12">
							<div class="new-single-image">
								<a href="#">
									<img src="../admin/files/Img_1481219941.jpg"  class="image-responsive" alt="">
								</a>
							</div>
							<div class="new-single-header">
								...
								<h2 class="main-title">
									<a href="#" class="">DUT Schorlarship 2</a>
								</h2>
